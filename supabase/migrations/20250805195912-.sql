-- Update the status transition function to handle Approval to Implementing transition
...
BEGIN
  ...
  IF (new_status = 'Review' OR new_status = 'Estimation' OR new_status = 'Implementing') AND old_status = 'Approval' THEN
