-- Fix the logic in update_request_status_and_assignee to prevent assignee changes 
-- when transitioning from "New" to "Estimation"
...
BEGIN
  ...
  -- Auto-assign consultant based on status, but NOT when transitioning from "New" to "Estimation"
  IF new_status IN ('Review', 'Implementing') THEN
