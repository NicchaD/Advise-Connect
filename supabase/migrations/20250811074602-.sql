-- Update the status transition from Estimation to Review to allow Advisory Consultant
UPDATE status_transitions 
SET role_required = 'Advisory Consultant'
WHERE from_status = 'Estimation' AND to_status = 'Review';

-- Update the update_request_status_and_assignee function to handle Estimation to Review transition properly
