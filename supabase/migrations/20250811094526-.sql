-- Update the Review to Estimation transition to allow Original Advisory Consultant
UPDATE status_transitions 
SET role_required = 'Original Advisory Consultant'
WHERE from_status = 'Review' AND to_status = 'Estimation';

-- Update the update_request_status_and_assignee function to handle Review to Estimation transition
...
BEGIN
  ...
  IF current_status = 'Implementing' AND new_status = 'Awaiting Feedback' THEN
