          ...
          {selectedRequest && (
            <div className="space-y-6">
              ...
              <RequestDetailsSection
                ...
                requestorDisplayName={getRequestorDisplayName(selectedRequest.requestor_profile, selectedRequest.requestor_id)}
                advisoryServiceMap={advisoryServiceMap}
                serviceOfferingMap={serviceOfferingMap}
                toolsMap={toolsMap}
                formatDate={formatDate}
                onProjectDataUpdate={(updatedData) => {
                  setSelectedRequest(prev => prev ? {
                    ...prev,
              ...
              {/* Activities Details Section - Show for Implemented status and later */}
